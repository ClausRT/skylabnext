  ...
  return (
    ...
    >
      ...
      <Flex gridArea="form" height="100%" backgroundColor="gray.700" borderRadius="md" flexDir="column" alignItems="stretch" padding={16}>
        <Input height="50px" borderColor="gray.800" focusBorderColor="purple.500" borderRadius="sm" placeholder="E-Mail" />
        <Input height="50px" borderColor="gray.800" focusBorderColor="purple.500" borderRadius="sm" placeholder="Senha" marginTop={2} />
        <Link
